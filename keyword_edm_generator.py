...
def createInsert(templateCategory, banner, filename):
    ...
    for i in range(2):
        ...
        html.write('                        <th width="20%"><a href="' + keywordArray[(i*5)][2] + '"><img src="' + keywordArray[(i*5)][0] + '" width="' + widthSize + 'px" height="' + heightSize + 'px"></a></th></div>\n')
        html.write('                        <th width="1%"></th>\n')
        html.write('                        <th width="20%"><a href="' + keywordArray[(i*5)+1][2] + '"><img src="' + keywordArray[(i*5)+1][0] + '" width="' + widthSize + 'px" height="' + heightSize + 'px"></a></th>\n')
        html.write('                        <th width="1%"></th>\n')
        html.write('                        <th width="20%"><a href="' + keywordArray[(i*5)+2][2] + '"><img src="' + keywordArray[(i*5)+2][0] + '" width="' + widthSize + 'px" height="' + heightSize + 'px"></a></th>\n')
        html.write('                        <th width="1%"></th>\n')
        html.write('                        <th width="20%"><a href="' + keywordArray[(i*5)+3][2] + '"><img src="' + keywordArray[(i*5)+3][0] + '" width="' + widthSize + 'px" height="' + heightSize + 'px"></a></th>\n')
        html.write('                        <th width="1%"></th>\n')
        html.write('                        <th width="20%"><a href="' + keywordArray[(i*5)+4][2] + '"><img src="' + keywordArray[(i*5)+4][0] + '" width="' + widthSize + 'px" height="' + heightSize + 'px"></a></th>\n')
        html.write('                        <th width="1%"></th>\n')
        html.write('                    </tr>\n')
        html.write('                    <tr>\n')
        html.write('                        <th></th>\n')
        html.write('                        <th><a href="' + keywordArray[(i*5)][2] + '" style="font-family: Helvetica, sans-serif; font-size:' + fontSize + 'px; color: #333; text-decoration: none;">' + keywordArray[(i*5)][1] + '</a></th>\n')
        html.write('                        <th></th>\n')
        html.write('                        <th><a href="' + keywordArray[(i*5)+1][2] + '" style="font-family: Helvetica, sans-serif; font-size:' + fontSize + 'px; color: #333; text-decoration: none;">' + keywordArray[(i*5)+1][1] + '</a></th>\n')
        html.write('                        <th></th>\n')
        html.write('                        <th><a href="' + keywordArray[(i*5)+2][2] + '" style="font-family: Helvetica, sans-serif; font-size:' + fontSize + 'px; color: #333; text-decoration: none;">' + keywordArray[(i*5)+2][1] + '</a></th>\n')
        html.write('                        <th></th>\n')
        html.write('                        <th><a href="' + keywordArray[(i*5)+3][2] + '" style="font-family: Helvetica, sans-serif; font-size:' + fontSize + 'px; color: #333; text-decoration: none;">' + keywordArray[(i*5)+3][1] + '</a></th>\n')
        html.write('                        <th></th>\n')
        html.write('                        <th><a href="' + keywordArray[(i*5)+4][2] + '" style="font-family: Helvetica, sans-serif; font-size:' + fontSize + 'px; color: #333; text-decoration: none;">' + keywordArray[(i*5)+4][1] + '</a></th>\n')
        html.write('                        <th></th>\n')
        html.write('                    </tr>\n')
        html.write('                    <tr>\n')
        html.write('                        <td></br ></td>\n')
