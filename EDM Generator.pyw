...
def createInsert(templateCategory, filename, headerText):
    ...
    for i in range(2):
        ...
        if i == 0:
            ...
            html.write('        <td><a href="' + keywordArray[i+2][1] + '" target="_blank"><img src="' + keywordArray[i+1][0] + '" width="185" alt=""></a></td>\n')
            html.write('        <td><a href="' + keywordArray[i+3][1] + '" target="_blank"><img src="' + keywordArray[i+2][0] + '" width="185" alt=""></a></td>\n')
            html.write('        <td><a href="' + keywordArray[i+4][1] + '" target="_blank"><img src="' + keywordArray[i+3][0] + '" width="185" alt=""></a></td>\n')
        else:
            html.write('        <td><a href="' + keywordArray[i+2][1] + '" target="_blank"><img src="' + keywordArray[i+3][0] + '" width="185" alt=""></a></td>\n')
            html.write('        <td><a href="' + keywordArray[i+3][1] + '" target="_blank"><img src="' + keywordArray[i+4][0] + '" width="185" alt=""></a></td>\n')
            html.write('        <td><a href="' + keywordArray[i+4][1] + '" target="_blank"><img src="' + keywordArray[i+5][0] + '" width="185" alt=""></a></td>\n')
        html.write('    </tr>\n')
    html.write('</table>\n')
    html.close()
